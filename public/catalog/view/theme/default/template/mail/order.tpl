...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="/image/catalog/logo-preto.png" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
